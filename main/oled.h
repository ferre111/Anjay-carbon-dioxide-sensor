...
#define OLED_X_SIZE                                 72
#define OLED_Y_SIZE                                 40 
#define OLED_NUM_OF_PAGES                           (OLED_Y_SIZE / 8)
#define OLED_X_SIZE_MAX                             128
#define OLED_Y_SIZE_MAX                             64
#define OLED_NUM_OF_PAGES_MAX                       (OLED_Y_SIZE_MAX / 8)
...
#define OLED_MAX_CHAR_PER_LINE                      21 // maximal number of char that fit in one line (with the smallest font and OLED_X_SIZE == 128)
